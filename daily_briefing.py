...
class TrueCrimeBriefingGenerator:
    ...
    def get_research_prompt(self):
        """Generate educational research prompt with explicit link requests"""
        from datetime import datetime
        # Use actual current date - force it to be current
        current_date = "December 14, 2024"  # Hardcode current date to avoid future date issues
...
**Required Information for Each Journalist:**
- Their full name and primary publication
- Their area of specialization 
- 3-5 notable published investigations or series WITH DIRECT LINKS
- Professional background information that's publicly available
- Contact information if publicly available (Twitter, email, etc.)

**CRITICAL: Please include actual URLs/links to their specific articles and investigations when mentioning their work. This is essential for verification and further research.**

**Format for Each Journalist:**

**[Journalist Name] - [Primary Publication]**
- **Specialization:** [Area of focus]
- **Notable Published Work:**
  • [Article Title] - [Publication] - [DIRECT LINK]
  • [Article Title] - [Publication] - [DIRECT LINK]  
  • [Article Title] - [Publication] - [DIRECT LINK]
- **Background:** [Professional background]
- **Contact:** [Public contact information if available]
- **Research Value:** [Why their work is significant]
...
Please provide detailed information about 5 notable investigative journalists who meet these criteria, ensuring you include working links to their specific published articles and investigations.
        """
